...
const defaultThemes: Theme[] = [
  ...
  // Mobile Themes
  {
    id: "mobile-shop",
    name: "Mobile Shop",
    description: "Mobil öncelikli modern e-ticaret uygulaması tasarımı",
    category: "mobile",
    image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&h=600&fit=crop",
    demoUrl: "#",
    features: ["Mobil Uyumlu", "Sepet Sistemi", "Ürün Galerisi", "Ödeme Entegrasyonu"],
    colorScheme: ["#6366f1", "#4f46e5", "#e0e7ff"],
    isNew: true,
  },
  {
    id: "mobile-restaurant",
    name: "Mobile Restaurant",
    description: "Restoran ve kafe için mobil sipariş uygulaması",
    category: "mobile",
    image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&h=600&fit=crop",
    demoUrl: "#",
    features: ["Dijital Menü", "Rezervasyon", "Sipariş Takibi", "Konum Entegrasyonu"],
    colorScheme: ["#f97316", "#ea580c", "#ffedd5"],
    isNew: true,
  },
  {
    id: "mobile-fitness",
    name: "Mobile Fitness",
    description: "Fitness ve spor için mobil uygulama tasarımı",
    category: "mobile",
    image: "https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?w=800&h=600&fit=crop",
    demoUrl: "#",
    features: ["Egzersiz Takibi", "Kalori Sayacı", "İlerleme Grafikleri", "Video Dersler"],
    colorScheme: ["#10b981", "#059669", "#d1fae5"],
    isNew: true,
  },
  {
    id: "mobile-social",
    name: "Mobile Social",
    description: "Sosyal medya uygulaması için mobil tasarım",
    category: "mobile",
    image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&h=600&fit=crop",
    demoUrl: "#",
    features: ["Hikayeler", "Mesajlaşma", "Bildirimler", "Canlı Yayın"],
    colorScheme: ["#ec4899", "#db2777", "#fce7f3"],
    isNew: true,
  },
];
